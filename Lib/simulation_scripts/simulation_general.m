...
% INPUT: none
% OUTPUT: params,obs
function [params,obs] = simulation_general
...
params_update = @params_update_TCV;
...
model_reference = @model_TCV_reference;
...
params = model_init('Ts',Ts,'T0',[t0, tend],'noise',0,'noise_spec',noise_mat, 'params_update', params_update, ...
        ...
        'input_enable',1,'input_law',input_law,'params_init',params_init,'params_init_vars',[n m q]);
...
obs = obsopt('DataType', 'simulated', 'optimise', 0, 'GlobalSearch', 0, 'MultiStart', 0, 'J_normalise', 1, 'MaxOptTime', Inf, 'MaxOptTime_single', Inf, ... 
      'Nw', Nw, 'Nts', Nts, 'ode', ode, 'PE_maxiter', 0 , 'model_reference', model_reference, 'WaitAllBuffer', 1, 'WeightTerms', [1] ,...    
      'measure_reference', measure_reference, 'params',params, 'filters', filterScale,'filterTF', filter, 'Jdot_thresh',0.9,'MaxIter',10,...
