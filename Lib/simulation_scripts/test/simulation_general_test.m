...
% INPUT: none
% OUTPUT: params,obs
function [params,obs] = simulation_general_test
...
% y = x(params.observed_state) (see params_init = @params_oscillator_VDP;
...
obs = obsopt('DataType', 'simulated', 'optimise', 1, ... 
      ...
      'Jterm_store', 1, 'AlwaysOpt', 1 , 'print', 0 , 'SafetyDensity', 3, 'AdaptiveHist', [1e-2, 3e-2, 1e0], ...
